...
export default function NavigationButton(props) {
    ...
    return (
        <Link className="navButtonLink mx-auto backdrop-blur backdrop-grayscale" href={props.name.toLowerCase()} onClick={() => props.setSelectedPage('/' + props.name.toLowerCase())}>
